    ...
    <nav className="site-nav" ref={navRef} aria-label="Primary navigation">
      ...
      <div className="site-actions">
        <div className="site-socials">
          <a href="https://www.instagram.com/j.merkus/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
            <svg className="social-icon social-icon-instagram" width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          ...
          <a href="https://www.linkedin.com/in/juliamerkusheva" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
